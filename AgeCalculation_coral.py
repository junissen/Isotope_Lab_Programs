...
class Application_sem():
    ...
    def age_calculate_sem(self):
        ...
        sheet['E' + row] = "{0:.1f}".format(two_ppt)
        sheet['F' + row] = "± " + "{0:.1f}".format(two_ppt_wt_err)
...
class Calculation_forCups():
    ...
    def U_calc(self, Ufile, Uwash, spiked_standard, spiked_standard_err, Uwash_option):
        ...
        if Uwash_option == "sem":
            ...
            #234
            working_four_mb = isofilter(self.filename_Uwash, "D")
            ...
            #235
            working_five_mb = isofilter(self.filename_Uwash, "E")
